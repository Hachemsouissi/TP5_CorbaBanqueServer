...
/**
* corbaBanque/CompteHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from Banque.idl
* lundi 3 novembre 2025 14 h 54 CET
*/

abstract public class CompteHelper
{
  private static String  _id = "IDL:corbaBanque/Compte:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (corbaBanque.CompteHelper.id (), "Compte", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    corbaBanque.Compte value = new corbaBanque.Compte ();
    value.code = istream.read_long ();
    value.solde = istream.read_float ();
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, corbaBanque.Compte value)
  {
    ...
    ostream.write_float (value.solde);
  }
